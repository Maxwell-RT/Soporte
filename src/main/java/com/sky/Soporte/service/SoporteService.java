...
public class SoporteService {
    ...
    public Soporte obtenerTicket(Long ticketid) {
        return soporteRepository.findById(ticketid).orElse(null);
    }

    public Soporte Guardarticket(Soporte soporte) {
        Soporte existente = soporteRepository.findById(soporte.getIdSoporte()).orElse(null);
        if (existente != null) {
